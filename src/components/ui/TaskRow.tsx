...
interface TaskRowProps {
  ...
  hasReminder?: boolean;
  /** Shows a small coral "Overdue" status text in the meta line, plus a full-bleed light coral row tint and the existing left accent. */
  overdue?: boolean;
  /** Date context shown before time/category, e.g. "Today", "Tomorrow", "Sunday", or "Sep 5" — applied consistently across every Tasks filter. */
  dateLabel?: string;
